...
**Classement ? / Leaderboard?** Non. La progression reste dans le navigateur. Pas de serveur. / No. Progress stays in the browser. No backend.

**Hors ligne ? / Offline?** Après la première visite, le service worker garde le jeu. / After the first visit, the service worker caches the shell.
